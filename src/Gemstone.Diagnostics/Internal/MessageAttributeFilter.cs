    ...
    : IEquatable<MessageAttributeFilter>
{
    ...
    public bool Equals(MessageAttributeFilter? other) =>
        other is not null && m_componentMessageSuppression == other.m_componentMessageSuppression && m_componentLevel == other.m_componentLevel && m_componentFlags == other.m_componentFlags
    ...
    public override bool Equals(object? obj) => 
        Equals(obj as MessageAttributeFilter);

    public override int GetHashCode() =>
        (int)m_componentMessageSuppression ^ (int)m_componentLevel ^ (int)m_componentFlags
    ...
    {
        m_componentMessageSuppression |= a.m_componentMessageSuppression;
        m_componentLevel |= a.m_componentLevel;
        m_componentFlags |= a.m_componentFlags;

        m_frameworkMessageSuppression |= a.m_frameworkMessageSuppression;
        m_frameworkLevel |= a.m_frameworkLevel;
        m_frameworkFlags |= a.m_frameworkFlags;

        m_applicationMessageSuppression |= a.m_applicationMessageSuppression;
        m_applicationLevel |= a.m_applicationLevel;
        m_applicationFlags |= a.m_applicationFlags;
    }
    ...
    public static MessageAttributeFilter? Create(VerboseLevel level) => 
        level == VerboseLevel.None ? null : new MessageAttributeFilter(level);
}

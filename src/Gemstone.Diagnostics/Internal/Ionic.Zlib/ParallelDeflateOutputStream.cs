...
namespace Gemstone.Diagnostics.Internal.Ionic.Zlib
{
...
#if !SILVERLIGHT
                    System.Console.ForegroundColor = (ConsoleColor) (tid % 8 + 8);
#endif
                    System.Console.Write("{0:000} PDOS ", tid);
                    System.Console.WriteLine(format, varParams);
#if !SILVERLIGHT

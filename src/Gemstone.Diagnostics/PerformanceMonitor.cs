...
public class PerformanceMonitor : PerformanceMonitorBase
{
    ...
    /// </summary>
    /// <remarks>This <see cref="PerformanceCounter"/> is added by default.</remarks>
    public PerformanceCounter ThreadingContentionRate => FindCounter("Contention Rate / sec");

    /// <summary>
    /// Gets the <see cref="PerformanceCounter"/> that monitors the memory utilization of the monitored process.
    /// </summary>
    /// <remarks>This <see cref="PerformanceCounter"/> is added by default.</remarks>
    public PerformanceCounter MemoryUsage => FindCounter("Working Set");
    ...
    /// </summary>
    /// <remarks>This <see cref="PerformanceCounter"/> is added by default.</remarks>
    public PerformanceCounter IOUsage => FindCounter("IO Data Bytes/sec");
    ...
    /// </summary>
    /// <remarks>This <see cref="PerformanceCounter"/> is added by default.</remarks>
    public PerformanceCounter IOActivity => FindCounter("IO Data Operations/sec");
    ...
    /// </summary>
    /// <remarks>This <see cref="PerformanceCounter"/> is added by default.</remarks>
    public PerformanceCounter HandleCount => FindCounter("Handle Count");
    ...
    /// </summary>
    /// <remarks>This <see cref="PerformanceCounter"/> is added by default.</remarks>
    public PerformanceCounter ThreadCount => FindCounter("Thread Count");

    /// <summary>
    /// Gets the friendly name of the <see cref="PerformanceMonitor"/> object.
    /// </summary>
    public override string Name => $"{base.Name}.{m_processName}";
